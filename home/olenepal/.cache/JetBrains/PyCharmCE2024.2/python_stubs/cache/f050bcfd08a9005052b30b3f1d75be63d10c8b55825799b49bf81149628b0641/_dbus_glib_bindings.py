...
__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_glib_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c8382320>, origin='/usr/lib/python3/dist-packages/_dbus_glib_bindings.cpython-310-x86_64-linux-gnu.so')"
