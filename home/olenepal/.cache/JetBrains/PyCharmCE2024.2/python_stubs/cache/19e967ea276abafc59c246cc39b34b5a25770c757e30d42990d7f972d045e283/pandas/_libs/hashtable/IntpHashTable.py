...
class IntpHashTable(HashTable):
    ...
    def get_na(self, *args, **kwargs): # real signature unknown
        """
    ...
    def map_keys_to_values(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_na(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874c48fd260>'
