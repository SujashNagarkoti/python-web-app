...
class Real(__numbers.Complex):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7874c7d40a40>'
    __abstractmethods__ = frozenset({'__rmod__', '__eq__', '__trunc__', '__radd__', '__round__', '__le__', '__truediv__', '__floor__', '__abs__', '__mul__', '__float__', '__add__', '__neg__', '__rmul__', '__ceil__', '__rtruediv__', '__pow__', '__rfloordiv__', '__mod__', '__rpow__', '__pos__', '__lt__', '__floordiv__'})
    __slots__ = ()
...
class Integral(__numbers.Rational):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7874c7c33980>'
    __abstractmethods__ = frozenset({'__rmod__', '__rlshift__', '__xor__', '__eq__', '__rrshift__', '__rand__', '__trunc__', '__radd__', '__lt__', '__round__', '__le__', '__ror__', '__int__', '__truediv__', '__and__', '__floor__', '__abs__', '__mul__', '__add__', '__neg__', '__rxor__', '__rmul__', '__lshift__', '__ceil__', '__rtruediv__', '__pow__', '__rfloordiv__', '__or__', '__mod__', '__rshift__', '__rpow__', '__pos__', '__invert__', '__floordiv__'})
    __slots__ = ()


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c7949840>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.varLib.iup', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c7949840>, origin='/home/olenepal/.local/lib/python3.10/site-packages/fontTools/varLib/iup.cpython-310-x86_64-linux-gnu.so')"
