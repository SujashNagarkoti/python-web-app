...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c8381ea0>'

__spec__ = None # (!) real value is "ModuleSpec(name='reportlab.graphics._renderPM', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c8381ea0>, origin='/usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-310-x86_64-linux-gnu.so')"
