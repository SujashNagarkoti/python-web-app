...
class _CustomBusinessMonth(BusinessMixin):
    ...
    cbday_roll = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7874c39bb180>'
    month_roll = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7874c39bb200>'
    m_offset = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7874c39bb1c0>'
    _attributes = (
        'n',
        'normalize',
        'weekmask',
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874c3906580>'
