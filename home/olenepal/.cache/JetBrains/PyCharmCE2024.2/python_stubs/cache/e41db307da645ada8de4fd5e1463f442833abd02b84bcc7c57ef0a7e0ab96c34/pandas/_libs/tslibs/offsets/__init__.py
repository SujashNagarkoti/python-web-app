...
_relativedelta_kwds = None # (!) real value is "{'microseconds', 'days', 'day', 'second', 'year', 'microsecond', 'minute', 'years', 'weekday', 'weeks', 'hour', 'minutes', 'months', 'milliseconds', 'nanoseconds', 'month', 'nanosecond', 'millisecond', 'hours', 'seconds'}"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c3905180>'

__pyx_capi__ = {
    'is_offset_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7874c3905620>'
    'is_tick_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7874c3905650>'
    'to_offset': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7874c39055f0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.offsets', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c3905180>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/offsets.cpython-310-x86_64-linux-gnu.so')"
