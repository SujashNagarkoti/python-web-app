...
class BaseOffset(object):
    ...
    freqstr = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7874c49189c0>'
    _adjust_dst = True
    _attributes = (
        'n',
        'normalize',
    ...
    _day_opt = None
    _params = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7874c3937380>'
