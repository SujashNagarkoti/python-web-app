...
class BlockIndex(SparseIndex):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874b1db64c0>'
...
class IntIndex(SparseIndex):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874b1db6460>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874b1db5f30>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.sparse', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874b1db5f30>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/sparse.cpython-310-x86_64-linux-gnu.so')"
