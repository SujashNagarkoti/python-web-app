...
class SFC64(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874c50572d0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c5057310>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._sfc64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c5057310>, origin='/home/olenepal/.local/lib/python3.10/site-packages/numpy/random/_sfc64.cpython-310-x86_64-linux-gnu.so')"
