...
class connection(object):
    ...
    def get_native_connection(self): # real signature unknown; restored from __doc__
    ...
    pgconn_ptr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
