...
class MinMaxReso(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timestamps\', \'__doc__\': "\\n    We need to define min/max/resolution on both the Timestamp _instance_\\n    and Timestamp class.  On an instance, these depend on the object\'s _reso.\\n    On the class, we default to the values we would get with nanosecond _reso.\\n\\n    See also: timedeltas.MinMaxReso\\n    ", \'__init__\': <cyfunction MinMaxReso.__init__ at 0x7874c39b9be0>, \'__get__\': <cyfunction MinMaxReso.__get__ at 0x7874c39b9cb0>, \'__set__\': <cyfunction MinMaxReso.__set__ at 0x7874c39b9d80>, \'__dict__\': <attribute \'__dict__\' of \'MinMaxReso\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'MinMaxReso\' objects>})'
...
class _Timestamp(__pandas__libs_tslibs_base.ABCTimestamp):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874c3907690>'
...
class Timestamp(_Timestamp):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timestamps\', \'__doc__\': "\\n    Pandas replacement for python datetime.datetime object.\\n\\n    Timestamp is the pandas equivalent of python\'s Datetime\\n    and is interchangeable with it in most cases. It\'s the type used\\n    for the entries that make up a DatetimeIndex, and other timeseries\\n    oriented data structures in pandas.\\n\\n    Parameters\\n    ----------\\n    ts_input : datetime-like, str, int, float\\n        Value to be converted to Timestamp.\\n    year, month, day : int\\n    hour, minute, second, microsecond : int, optional, default 0\\n    tzinfo : datetime.tzinfo, optional, default None\\n    nanosecond : int, optional, default 0\\n    tz : str, pytz.timezone, dateutil.tz.tzfile or None\\n        Time zone for time which Timestamp will have.\\n    unit : str\\n        Unit used for conversion if ts_input is of type int or float. The\\n        valid values are \'D\', \'h\', \'m\', \'s\', \'ms\', \'us\', and \'ns\'. For\\n        example, \'s\' means seconds and \'ms\' means milliseconds.\\n\\n        For float inputs, the result will be stored in nanoseconds, and\\n        the unit attribute will be set as ``\'ns\'``.\\n    fold : {0, 1}, default None, keyword-only\\n        Due to daylight saving time, one wall clock time can occur twice\\n        when shifting from summer to winter time; fold describes whether the\\n        datetime-like corresponds  to the first (0) or the second time (1)\\n        the wall clock hits the ambiguous time.\\n\\n    Notes\\n    -----\\n    There are essentially three calling conventions for the constructor. The\\n    primary form accepts four parameters. They can be passed by position or\\n    keyword.\\n\\n    The other two forms mimic the parameters from ``datetime.datetime``. They\\n    can be passed by either position or keyword, but not both mixed together.\\n\\n    Examples\\n    --------\\n    Using the primary calling convention:\\n\\n    This converts a datetime-like string\\n\\n    >>> pd.Timestamp(\'2017-01-01T12\')\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    This converts a float representing a Unix epoch in units of seconds\\n\\n    >>> pd.Timestamp(1513393355.5, unit=\'s\')\\n    Timestamp(\'2017-12-16 03:02:35.500000\')\\n\\n    This converts an int representing a Unix-epoch in units of seconds\\n    and for a particular timezone\\n\\n    >>> pd.Timestamp(1513393355, unit=\'s\', tz=\'US/Pacific\')\\n    Timestamp(\'2017-12-15 19:02:35-0800\', tz=\'US/Pacific\')\\n\\n    Using the other two forms that mimic the API for ``datetime.datetime``:\\n\\n    >>> pd.Timestamp(2017, 1, 1, 12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    >>> pd.Timestamp(year=2017, month=1, day=1, hour=12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n    ", \'fromordinal\': <classmethod(<cyfunction Timestamp.fromordinal at 0x7874c39b9e50>)>, \'now\': <classmethod(<cyfunction Timestamp.now at 0x7874c39b9f20>)>, \'today\': <classmethod(<cyfunction Timestamp.today at 0x7874c39b9ff0>)>, \'utcnow\': <classmethod(<cyfunction Timestamp.utcnow at 0x7874c39ba0c0>)>, \'utcfromtimestamp\': <classmethod(<cyfunction Timestamp.utcfromtimestamp at 0x7874c39ba190>)>, \'fromtimestamp\': <classmethod(<cyfunction Timestamp.fromtimestamp at 0x7874c39ba260>)>, \'strftime\': <cyfunction Timestamp.strftime at 0x7874c39ba330>, \'ctime\': <cyfunction Timestamp.ctime at 0x7874c39ba400>, \'date\': <cyfunction Timestamp.date at 0x7874c39ba4d0>, \'dst\': <cyfunction Timestamp.dst at 0x7874c39ba5a0>, \'isocalendar\': <cyfunction Timestamp.isocalendar at 0x7874c39ba670>, \'tzname\': <cyfunction Timestamp.tzname at 0x7874c39ba740>, \'utcoffset\': <cyfunction Timestamp.utcoffset at 0x7874c39ba810>, \'utctimetuple\': <cyfunction Timestamp.utctimetuple at 0x7874c39ba8e0>, \'time\': <cyfunction Timestamp.time at 0x7874c39ba9b0>, \'timetuple\': <cyfunction Timestamp.timetuple at 0x7874c39baa80>, \'timetz\': <cyfunction Timestamp.timetz at 0x7874c39bab50>, \'toordinal\': <cyfunction Timestamp.toordinal at 0x7874c39bac20>, \'strptime\': <classmethod(<cyfunction Timestamp.strptime at 0x7874c39bacf0>)>, \'combine\': <classmethod(<cyfunction Timestamp.combine at 0x7874c39badc0>)>, \'__new__\': <cyfunction Timestamp.__new__ at 0x7874c39bae90>, \'_round\': <cyfunction Timestamp._round at 0x7874c39baf60>, \'round\': <cyfunction Timestamp.round at 0x7874c39bb030>, \'floor\': <cyfunction Timestamp.floor at 0x7874c39bb100>, \'ceil\': <cyfunction Timestamp.ceil at 0x7874c39bb1d0>, \'tz\': <property object at 0x7874c399c270>, \'tz_localize\': <cyfunction Timestamp.tz_localize at 0x7874c39bb440>, \'tz_convert\': <cyfunction Timestamp.tz_convert at 0x7874c39bb510>, \'astimezone\': <cyfunction Timestamp.tz_convert at 0x7874c39bb510>, \'replace\': <cyfunction Timestamp.replace at 0x7874c39bb5e0>, \'to_julian_date\': <cyfunction Timestamp.to_julian_date at 0x7874c39bb6b0>, \'isoweekday\': <cyfunction Timestamp.isoweekday at 0x7874c39bb780>, \'weekday\': <cyfunction Timestamp.weekday at 0x7874c39bb850>, \'__dict__\': <attribute \'__dict__\' of \'Timestamp\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timestamp\' objects>, \'weekofyear\': <attribute \'week\' of \'pandas._libs.tslibs.timestamps._Timestamp\' objects>, \'daysinmonth\': <attribute \'days_in_month\' of \'pandas._libs.tslibs.timestamps._Timestamp\' objects>})'


# variables with complex values

_no_input = None # (!) real value is '<object object at 0x7874c878b2a0>'

_zero_time = None # (!) real value is 'datetime.time(0, 0)'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c3906b30>'

__pyx_capi__ = {
    'create_timestamp_from_ts': None, # (!) real value is '<capsule object "struct __pyx_obj_6pandas_5_libs_6tslibs_10timestamps__Timestamp *(__pyx_t_5numpy_int64_t, npy_datetimestruct, PyDateTime_TZInfo *, int, struct __pyx_opt_args_6pandas_5_libs_6tslibs_10timestamps_create_timestamp_from_ts *__pyx_optional_args)" at 0x7874c3907660>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timestamps', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c3906b30>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/timestamps.cpython-310-x86_64-linux-gnu.so')"
