...
# from /home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/dtypes.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
def get_supported_reso(*args, **kwargs): # real signature unknown
    pass
...
class Enum(object):
    ...
    name = None # (!) real value is '<types.DynamicClassAttribute object at 0x7874c86a52d0>'
    value = None # (!) real value is '<types.DynamicClassAttribute object at 0x7874c86a52a0>'
    _member_map_ = {}
    _member_names_ = []
    _member_type_ = object
    _value2member_map_ = {}
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'enum', '__doc__': '\\n    Generic enumeration.\\n\\n    Derive from this class to define new enumerations.\\n    ', '__new__': <staticmethod(<function Enum.__new__ at 0x7874c86e91b0>)>, '_generate_next_value_': <function Enum._generate_next_value_ at 0x7874c86e9240>, '_missing_': <classmethod(<function Enum._missing_ at 0x7874c86e92d0>)>, '__repr__': <function Enum.__repr__ at 0x7874c86e9360>, '__str__': <function Enum.__str__ at 0x7874c86e93f0>, '__dir__': <function Enum.__dir__ at 0x7874c86e9480>, '__format__': <function Enum.__format__ at 0x7874c86e9510>, '__hash__': <function Enum.__hash__ at 0x7874c86e95a0>, '__reduce_ex__': <function Enum.__reduce_ex__ at 0x7874c86e9630>, 'name': <types.DynamicClassAttribute object at 0x7874c86a52d0>, 'value': <types.DynamicClassAttribute object at 0x7874c86a52a0>, '__dict__': <attribute '__dict__' of 'Enum' objects>, '__weakref__': <attribute '__weakref__' of 'Enum' objects>, '_member_names_': [], '_member_map_': {}, '_member_type_': <class 'object'>, '_value2member_map_': {}})"
...
class PeriodDtypeBase(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874c48fef70>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c48fed40>'

__pyx_capi__ = {
    'abbrev_to_npy_unit': None, # (!) real value is '<capsule object "NPY_DATETIMEUNIT (PyObject *, int __pyx_skip_dispatch)" at 0x7874c48fee20>'
    'attrname_to_abbrevs': None, # (!) real value is '<capsule object "PyObject *" at 0x7874c48fed60>'
    'attrname_to_npy_unit': None, # (!) real value is '<capsule object "PyObject *" at 0x7874c48fedc0>'
    'freq_group_code_to_npy_unit': None, # (!) real value is '<capsule object "NPY_DATETIMEUNIT (int)" at 0x7874c48fee50>'
    'get_supported_reso': None, # (!) real value is '<capsule object "NPY_DATETIMEUNIT (NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7874c48feee0>'
    'is_supported_unit': None, # (!) real value is '<capsule object "int (NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7874c48fef10>'
    'npy_unit_to_abbrev': None, # (!) real value is '<capsule object "PyObject *(NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7874c48fedf0>'
    'npy_unit_to_attrname': None, # (!) real value is '<capsule object "PyObject *" at 0x7874c48fed90>'
    'periods_per_day': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_6dtypes_periods_per_day *__pyx_optional_args)" at 0x7874c48fee80>'
    'periods_per_second': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7874c48feeb0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.dtypes', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c48fed40>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/dtypes.cpython-310-x86_64-linux-gnu.so')"

__test__ = {
    'Resolution.attrname (line 234)': "\n        Return datetime attribute name corresponding to this Resolution.\n\n        Examples\n        --------\n        >>> Resolution.RESO_SEC.attrname\n        'second'\n        ",
    'Resolution.from_attrname (line 246)': "\n        Return resolution str against resolution code.\n\n        Examples\n        --------\n        >>> Resolution.from_attrname('second')\n        <Resolution.RESO_SEC: 3>\n\n        >>> Resolution.from_attrname('second') == Resolution.RESO_SEC\n        True\n        ",
    'Resolution.get_reso_from_freqstr (line 261)': "\n        Return resolution code against frequency str.\n\n        `freq` is given by the `offset.freqstr` for some DateOffset object.\n\n        Examples\n        --------\n        >>> Resolution.get_reso_from_freqstr('H')\n        <Resolution.RESO_HR: 5>\n\n        >>> Resolution.get_reso_from_freqstr('H') == Resolution.RESO_HR\n        True\n        ",
}
