...
class MinMaxReso(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timedeltas\', \'__doc__\': "\\n    We need to define min/max/resolution on both the Timedelta _instance_\\n    and Timedelta class.  On an instance, these depend on the object\'s _reso.\\n    On the class, we default to the values we would get with nanosecond _reso.\\n    ", \'__init__\': <cyfunction MinMaxReso.__init__ at 0x7874c39b8110>, \'__get__\': <cyfunction MinMaxReso.__get__ at 0x7874c39b81e0>, \'__set__\': <cyfunction MinMaxReso.__set__ at 0x7874c39b82b0>, \'__dict__\': <attribute \'__dict__\' of \'MinMaxReso\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'MinMaxReso\' objects>})'
...
class _Timedelta(__datetime.timedelta):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874c3944780>'
...
class Timedelta(_Timedelta):
    ...
    _req_any_kwargs_new = None # (!) real value is "{'weeks', 'nanoseconds', 'minutes', 'hours', 'microseconds', 'milliseconds', 'seconds', 'days'}"
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timedeltas\', \'__doc__\': \'\\n    Represents a duration, the difference between two dates or times.\\n\\n    Timedelta is the pandas equivalent of python\\\'s ``datetime.timedelta``\\n    and is interchangeable with it in most cases.\\n\\n    Parameters\\n    ----------\\n    value : Timedelta, timedelta, np.timedelta64, str, or int\\n    unit : str, default \\\'ns\\\'\\n        Denote the unit of the input, if input is an integer.\\n\\n        Possible values:\\n\\n        * \\\'W\\\', \\\'D\\\', \\\'T\\\', \\\'S\\\', \\\'L\\\', \\\'U\\\', or \\\'N\\\'\\n        * \\\'days\\\' or \\\'day\\\'\\n        * \\\'hours\\\', \\\'hour\\\', \\\'hr\\\', or \\\'h\\\'\\n        * \\\'minutes\\\', \\\'minute\\\', \\\'min\\\', or \\\'m\\\'\\n        * \\\'seconds\\\', \\\'second\\\', or \\\'sec\\\'\\n        * \\\'milliseconds\\\', \\\'millisecond\\\', \\\'millis\\\', or \\\'milli\\\'\\n        * \\\'microseconds\\\', \\\'microsecond\\\', \\\'micros\\\', or \\\'micro\\\'\\n        * \\\'nanoseconds\\\', \\\'nanosecond\\\', \\\'nanos\\\', \\\'nano\\\', or \\\'ns\\\'.\\n\\n    **kwargs\\n        Available kwargs: {days, seconds, microseconds,\\n        milliseconds, minutes, hours, weeks}.\\n        Values for construction in compat with datetime.timedelta.\\n        Numpy ints and floats will be coerced to python ints and floats.\\n\\n    Notes\\n    -----\\n    The constructor may take in either both values of value and unit or\\n    kwargs as above. Either one of them must be used during initialization\\n\\n    The ``.value`` attribute is always in ns.\\n\\n    If the precision is higher than nanoseconds, the precision of the duration is\\n    truncated to nanoseconds.\\n\\n    Examples\\n    --------\\n    Here we initialize Timedelta object with both value and unit\\n\\n    >>> td = pd.Timedelta(1, "d")\\n    >>> td\\n    Timedelta(\\\'1 days 00:00:00\\\')\\n\\n    Here we initialize the Timedelta object with kwargs\\n\\n    >>> td2 = pd.Timedelta(days=1)\\n    >>> td2\\n    Timedelta(\\\'1 days 00:00:00\\\')\\n\\n    We see that either way we get the same result\\n    \', \'_req_any_kwargs_new\': {\'weeks\', \'nanoseconds\', \'minutes\', \'hours\', \'microseconds\', \'milliseconds\', \'seconds\', \'days\'}, \'__new__\': <cyfunction Timedelta.__new__ at 0x7874c39b8380>, \'__setstate__\': <cyfunction Timedelta.__setstate__ at 0x7874c39b8450>, \'__reduce__\': <cyfunction Timedelta.__reduce__ at 0x7874c39b8520>, \'_round\': <cyfunction Timedelta._round at 0x7874c39b85f0>, \'round\': <cyfunction Timedelta.round at 0x7874c39b86c0>, \'floor\': <cyfunction Timedelta.floor at 0x7874c39b8790>, \'ceil\': <cyfunction Timedelta.ceil at 0x7874c39b8860>, \'__neg__\': <cyfunction _op_unary_method.<locals>.f at 0x7874c39b8a00>, \'__pos__\': <cyfunction _op_unary_method.<locals>.f at 0x7874c39b8ba0>, \'__abs__\': <cyfunction _op_unary_method.<locals>.f at 0x7874c39b8d40>, \'__add__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7874c39b8ee0>, \'__radd__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7874c39b9080>, \'__sub__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7874c39b9220>, \'__rsub__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7874c39b93c0>, \'__mul__\': <cyfunction Timedelta.__mul__ at 0x7874c39b9490>, \'__rmul__\': <cyfunction Timedelta.__mul__ at 0x7874c39b9490>, \'__truediv__\': <cyfunction Timedelta.__truediv__ at 0x7874c39b9560>, \'__rtruediv__\': <cyfunction Timedelta.__rtruediv__ at 0x7874c39b9630>, \'__floordiv__\': <cyfunction Timedelta.__floordiv__ at 0x7874c39b9700>, \'__rfloordiv__\': <cyfunction Timedelta.__rfloordiv__ at 0x7874c39b97d0>, \'__mod__\': <cyfunction Timedelta.__mod__ at 0x7874c39b98a0>, \'__rmod__\': <cyfunction Timedelta.__rmod__ at 0x7874c39b9970>, \'__divmod__\': <cyfunction Timedelta.__divmod__ at 0x7874c39b9a40>, \'__rdivmod__\': <cyfunction Timedelta.__rdivmod__ at 0x7874c39b9b10>, \'__dict__\': <attribute \'__dict__\' of \'Timedelta\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timedelta\' objects>})'


# variables with complex values

_no_input = None # (!) real value is '<object object at 0x7874c878b1e0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c3907f70>'

__pyx_capi__ = {
    'convert_to_timedelta64': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *)" at 0x7874c3944720>'
    'delta_to_nanoseconds': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_10timedeltas_delta_to_nanoseconds *__pyx_optional_args)" at 0x7874c39446f0>'
    'is_any_td_scalar': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7874c3944750>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timedeltas', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c3907f70>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/timedeltas.cpython-310-x86_64-linux-gnu.so')"
