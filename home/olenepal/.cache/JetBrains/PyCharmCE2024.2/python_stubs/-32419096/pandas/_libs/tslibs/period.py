...
class Period(_Period):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.period\', \'__doc__\': "\\n    Represents a period of time.\\n\\n    Parameters\\n    ----------\\n    value : Period, str, datetime, date or pandas.Timestamp, default None\\n        The time period represented (e.g., \'4Q2005\'). This represents neither\\n        the start or the end of the period, but rather the entire period itself.\\n    freq : str, default None\\n        One of pandas period strings or corresponding objects. Accepted\\n        strings are listed in the\\n        :ref:`period alias section <timeseries.period_aliases>` in the user docs.\\n        If value is datetime, freq is required.\\n    ordinal : int, default None\\n        The period offset from the proleptic Gregorian epoch.\\n    year : int, default None\\n        Year value of the period.\\n    month : int, default 1\\n        Month value of the period.\\n    quarter : int, default None\\n        Quarter value of the period.\\n    day : int, default 1\\n        Day value of the period.\\n    hour : int, default 0\\n        Hour value of the period.\\n    minute : int, default 0\\n        Minute value of the period.\\n    second : int, default 0\\n        Second value of the period.\\n\\n    Examples\\n    --------\\n    >>> period = pd.Period(\'2012-1-1\', freq=\'D\')\\n    >>> period\\n    Period(\'2012-01-01\', \'D\')\\n    ", \'__new__\': <cyfunction Period.__new__ at 0x7874c3991e50>, \'__dict__\': <attribute \'__dict__\' of \'Period\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Period\' objects>})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874bdb00fd0>'

__pyx_capi__ = {
    'get_period_ordinal': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (npy_datetimestruct *, int)" at 0x7874bdb01680>'
    'is_period_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7874bdb01650>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.period', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874bdb00fd0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/period.cpython-310-x86_64-linux-gnu.so')"
