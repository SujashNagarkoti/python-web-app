...
class NDArrayBacked(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7874be77e4c0>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874be77e5c0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.arrays', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874be77e5c0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/arrays.cpython-310-x86_64-linux-gnu.so')"
