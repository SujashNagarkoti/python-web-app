...
# from /usr/lib/python3/dist-packages/systemd/_daemon.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
def _is_socket_sockaddr(fd, address, type=0, flowinfo=0, listening=-1): # real signature unknown; restored from __doc__
    """
...
__spec__ = None # (!) real value is "ModuleSpec(name='systemd._daemon', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c8382170>, origin='/usr/lib/python3/dist-packages/systemd/_daemon.cpython-310-x86_64-linux-gnu.so')"
