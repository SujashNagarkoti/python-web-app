...
CAPI = None # (!) real value is '<capsule object "cairo.CAPI" at 0x7874c838cd50>'
...
__spec__ = None # (!) real value is "ModuleSpec(name='cairo._cairo', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c8381f90>, origin='/usr/lib/python3/dist-packages/cairo/_cairo.cpython-310-x86_64-linux-gnu.so')"
