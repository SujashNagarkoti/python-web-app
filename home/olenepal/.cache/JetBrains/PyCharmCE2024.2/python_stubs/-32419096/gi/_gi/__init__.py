# encoding: utf-8
# module gi._gi
# from /usr/lib/python3/dist-packages/gi/_gi.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
def pygobject_new_full(*args, **kwargs): # real signature unknown
    pass

def pyos_getsig(*args, **kwargs): # real signature unknown
    pass

def register_foreign(*args, **kwargs): # real signature unknown
    pass
...
def _gvalue_get_type(*args, **kwargs): # real signature unknown
    pass
...
TYPE_GSTRING = None # (!) real value is '<GType GString (108606180183328)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7874c838e2e0>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7874c838e940>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c838c580>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7874c838c580>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-310-x86_64-linux-gnu.so')"
