...
openssl_md_meth_names = None # (!) real value is "frozenset({'blake2s', 'sha3_256', 'sha1', 'sha224', 'sha256', 'sha3_384', 'sha384', 'md5', 'sha512_256', 'sha3_224', 'shake_128', 'md5-sha1', 'blake2b', 'sm3', 'shake_256', 'sha512_224', 'sha512', 'sha3_512'})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7e4faf23e2c0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7e4faf23e2c0>, origin='/usr/lib/python3.10/lib-dynload/_hashlib.cpython-310-x86_64-linux-gnu.so')"
