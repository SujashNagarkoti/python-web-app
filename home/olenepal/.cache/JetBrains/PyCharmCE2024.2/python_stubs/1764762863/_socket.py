...
CAPI = None # (!) real value is '<capsule object "_socket.CAPI" at 0x7bc8c9f73660>'

__spec__ = None # (!) real value is "ModuleSpec(name='_socket', loader=<class '_frozen_importlib.BuiltinImporter'>, origin='built-in')"
