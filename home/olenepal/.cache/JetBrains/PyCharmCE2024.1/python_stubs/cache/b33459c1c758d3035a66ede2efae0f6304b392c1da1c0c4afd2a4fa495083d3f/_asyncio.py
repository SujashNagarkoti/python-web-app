# encoding: utf-8
# module _asyncio
# from /usr/lib/python3.10/lib-dynload/_asyncio.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
...
class Future(object):
    ...
    def _make_cancelled_error(self, *args, **kwargs): # real signature unknown
        """
    ...
    _cancel_message = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
__spec__ = None # (!) real value is "ModuleSpec(name='_asyncio', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7548f19d9450>, origin='/usr/lib/python3.10/lib-dynload/_asyncio.cpython-310-x86_64-linux-gnu.so')"
