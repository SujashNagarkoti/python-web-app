...
def interrupt_main(signum=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
class LockType(object):
    ...
    def _at_fork_reinit(self, *args, **kwargs): # real signature unknown
        pass
