...
# from /usr/lib/python3/dist-packages/systemd/_reader.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
...
class _Reader(object):
    ...
    def enumerate_fields(self, field): # real signature unknown; restored from __doc__
        """
    ...
    def has_persistent_files(self, p_str): # real signature unknown; restored from __doc__
        """
    ...
    def has_runtime_files(self, p_str): # real signature unknown; restored from __doc__
        """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047ce1d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd._reader', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047ce1d0>, origin='/usr/lib/python3/dist-packages/systemd/_reader.cpython-310-x86_64-linux-gnu.so')"
