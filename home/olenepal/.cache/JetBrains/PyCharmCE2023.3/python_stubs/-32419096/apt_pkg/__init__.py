# encoding: utf-8
# module apt_pkg
# from /usr/lib/python3/dist-packages/apt_pkg.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
def parse_depends(s, strip_multi_arch=True, architecture=None): # real signature unknown; restored from __doc__
    """
...
def parse_src_depends(s, strip_multi_arch=True, architecture=None): # real signature unknown; restored from __doc__
    """
...
def pkgsystem_is_locked(): # real signature unknown; restored from __doc__
    """
...
def pkgsystem_lock_inner(): # real signature unknown; restored from __doc__
    """
...
def pkgsystem_unlock_inner(): # real signature unknown; restored from __doc__
    """
...
from .CacheMismatchError import CacheMismatchError
...
from .HashStringList import HashStringList
...
from .SourceRecordFiles import SourceRecordFiles
from .SourceRecords import SourceRecords
from .SystemLock import SystemLock
from .Tag import Tag
from .TagFile import TagFile
from .TagRemove import TagRemove
from .TagRename import TagRename
from .TagRewrite import TagRewrite
from .TagSection import TagSection
from .Version import Version
# variables with complex values

config = None # (!) real value is '<apt_pkg.Configuration object at 0x7fd3047ce400>'
...
_C_API = None # (!) real value is '<capsule object "apt_pkg._C_API" at 0x7fd3047cdbc0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047ce380>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_pkg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047ce380>, origin='/usr/lib/python3/dist-packages/apt_pkg.cpython-310-x86_64-linux-gnu.so')"
