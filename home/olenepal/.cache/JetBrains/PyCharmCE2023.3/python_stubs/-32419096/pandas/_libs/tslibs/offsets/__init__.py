...
_relativedelta_kwds = None # (!) real value is "{'month', 'second', 'seconds', 'microsecond', 'nanosecond', 'microseconds', 'minutes', 'nanoseconds', 'years', 'day', 'millisecond', 'months', 'year', 'days', 'weekday', 'hours', 'hour', 'minute', 'milliseconds', 'weeks'}"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef2a90f0>'

__pyx_capi__ = {
    'is_offset_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7fd2ef2a9590>'
    'is_tick_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7fd2ef2a95c0>'
    'to_offset': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7fd2ef2a9560>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.offsets', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef2a90f0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/offsets.cpython-310-x86_64-linux-gnu.so')"

__test__ = {
    'BaseOffset.copy (line 535)': '\n        Return a copy of the frequency.\n\n        Examples\n        --------\n        >>> freq = pd.DateOffset(1)\n        >>> freq_copy = freq.copy()\n        >>> freq is freq_copy\n        False\n        ',
    'BaseOffset.freqstr (line 611)': "\n        Return a string representing the frequency.\n\n        Examples\n        --------\n        >>> pd.DateOffset(5).freqstr\n        '<5 * DateOffsets>'\n\n        >>> pd.offsets.BusinessHour(2).freqstr\n        '2BH'\n\n        >>> pd.offsets.Nano().freqstr\n        'N'\n\n        >>> pd.offsets.Nano(-3).freqstr\n        '-3N'\n        ",
    'BaseOffset.is_anchored (line 793)': '\n        Return boolean whether the frequency is a unit frequency (n=1).\n\n        Examples\n        --------\n        >>> pd.DateOffset().is_anchored()\n        True\n        >>> pd.DateOffset(2).is_anchored()\n        False\n        ',
    'BaseOffset.is_month_end (line 823)': '\n        Return boolean whether a timestamp occurs on the month end.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Hour(5)\n        >>> freq.is_month_end(ts)\n        False\n        ',
    'BaseOffset.is_month_start (line 810)': '\n        Return boolean whether a timestamp occurs on the month start.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Hour(5)\n        >>> freq.is_month_start(ts)\n        True\n        ',
    'BaseOffset.is_on_offset (line 699)': "\n        Return boolean whether a timestamp intersects with this frequency.\n\n        Parameters\n        ----------\n        dt : datetime.datetime\n            Timestamp to check intersections with frequency.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Day(1)\n        >>> freq.is_on_offset(ts)\n        True\n\n        >>> ts = pd.Timestamp(2022, 8, 6)\n        >>> ts.day_name()\n        'Saturday'\n        >>> freq = pd.offsets.BusinessDay(1)\n        >>> freq.is_on_offset(ts)\n        False\n        ",
    'BaseOffset.is_quarter_end (line 849)': '\n        Return boolean whether a timestamp occurs on the quarter end.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Hour(5)\n        >>> freq.is_quarter_end(ts)\n        False\n        ',
    'BaseOffset.is_quarter_start (line 836)': '\n        Return boolean whether a timestamp occurs on the quarter start.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Hour(5)\n        >>> freq.is_quarter_start(ts)\n        True\n        ',
    'BaseOffset.is_year_end (line 875)': '\n        Return boolean whether a timestamp occurs on the year end.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Hour(5)\n        >>> freq.is_year_end(ts)\n        False\n        ',
    'BaseOffset.is_year_start (line 862)': '\n        Return boolean whether a timestamp occurs on the year start.\n\n        Examples\n        --------\n        >>> ts = pd.Timestamp(2022, 1, 1)\n        >>> freq = pd.offsets.Hour(5)\n        >>> freq.is_year_start(ts)\n        True\n        ',
    'BaseOffset.kwds.__get__ (line 453)': "\n        Return a dict of extra parameters for the offset.\n\n        Examples\n        --------\n        >>> pd.DateOffset(5).kwds\n        {}\n\n        >>> pd.offsets.FY5253Quarter().kwds\n        {'weekday': 0,\n         'startingMonth': 1,\n         'qtr_with_extra_week': 1,\n         'variation': 'nearest'}\n        ",
    'BaseOffset.name.__get__ (line 588)': "\n        Return a string representing the base frequency.\n\n        Examples\n        --------\n        >>> pd.offsets.Hour().name\n        'H'\n\n        >>> pd.offsets.Hour(5).name\n        'H'\n        ",
    'Tick.nanos.__get__ (line 956)': '\n        Return an integer of the total number of nanoseconds.\n\n        Raises\n        ------\n        ValueError\n            If the frequency is non-fixed.\n\n        Examples\n        --------\n        >>> pd.offsets.Hour(5).nanos\n        18000000000000\n        ',
    'to_offset (line 4460)': '\n    Return DateOffset object from string or datetime.timedelta object.\n\n    Parameters\n    ----------\n    freq : str, datetime.timedelta, BaseOffset or None\n\n    Returns\n    -------\n    BaseOffset subclass or None\n\n    Raises\n    ------\n    ValueError\n        If freq is an invalid frequency\n\n    See Also\n    --------\n    BaseOffset : Standard kind of date increment used for a date range.\n\n    Examples\n    --------\n    >>> from pandas.tseries.frequencies import to_offset\n    >>> to_offset("5min")\n    <5 * Minutes>\n\n    >>> to_offset("1D1H")\n    <25 * Hours>\n\n    >>> to_offset("2W")\n    <2 * Weeks: weekday=6>\n\n    >>> to_offset("2B")\n    <2 * BusinessDays>\n\n    >>> to_offset(pd.Timedelta(days=1))\n    <Day>\n\n    >>> to_offset(pd.offsets.Hour())\n    <Hour>\n    ',
}
