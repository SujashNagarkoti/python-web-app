...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2eed7d570>'

__pyx_capi__ = {
    'c_is_list_like': None, # (!) real value is '<capsule object "int (PyObject *, int)" at 0x7fd2eed7e460>'
    'eq_NA_compat': None, # (!) real value is '<capsule object "PyArrayObject *(PyArrayObject *, PyObject *, int __pyx_skip_dispatch)" at 0x7fd2eed7e490>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.lib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2eed7d570>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/lib.cpython-310-x86_64-linux-gnu.so')"
