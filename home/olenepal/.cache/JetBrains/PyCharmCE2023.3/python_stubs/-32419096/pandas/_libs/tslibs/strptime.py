...
class LocaleTime(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_strptime', '__doc__': 'Stores and handles locale-specific information related to time.\\n\\n    ATTRIBUTES:\\n        f_weekday -- full weekday names (7-item list)\\n        a_weekday -- abbreviated weekday names (7-item list)\\n        f_month -- full month names (13-item list; dummy value in [0], which\\n                    is added by code)\\n        a_month -- abbreviated month names (13-item list, dummy value in\\n                    [0], which is added by code)\\n        am_pm -- AM/PM representation (2-item list)\\n        LC_date_time -- format string for date/time representation (string)\\n        LC_date -- format string for date representation (string)\\n        LC_time -- format string for time representation (string)\\n        timezone -- daylight- and non-daylight-savings timezone representation\\n                    (2-item list of sets)\\n        lang -- Language used by instance (2-item tuple)\\n    ', '__init__': <function LocaleTime.__init__ at 0x7fd2ef381cf0>, '_LocaleTime__calc_weekday': <function LocaleTime.__calc_weekday at 0x7fd2ef381d80>, '_LocaleTime__calc_month': <function LocaleTime.__calc_month at 0x7fd2ef381e10>, '_LocaleTime__calc_am_pm': <function LocaleTime.__calc_am_pm at 0x7fd2ef381ea0>, '_LocaleTime__calc_date_time': <function LocaleTime.__calc_date_time at 0x7fd2ef381f30>, '_LocaleTime__calc_timezone': <function LocaleTime.__calc_timezone at 0x7fd2ef381fc0>, '__dict__': <attribute '__dict__' of 'LocaleTime' objects>, '__weakref__': <attribute '__weakref__' of 'LocaleTime' objects>})"
...
class _TimeRE(dict):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_strptime', '__doc__': 'Handle conversion from format directives to regexes.', '__init__': <function TimeRE.__init__ at 0x7fd2ef382050>, '_TimeRE__seqToRE': <function TimeRE.__seqToRE at 0x7fd2ef3820e0>, 'pattern': <function TimeRE.pattern at 0x7fd2ef382170>, 'compile': <function TimeRE.compile at 0x7fd2ef382200>, '__dict__': <attribute '__dict__' of 'TimeRE' objects>, '__weakref__': <attribute '__weakref__' of 'TimeRE' objects>})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2eed3c280>'

__pyx_capi__ = {
    'parse_today_now': None, # (!) real value is '<capsule object "int (PyObject *, __pyx_t_5numpy_int64_t *, int)" at 0x7fd2eed3c750>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.strptime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2eed3c280>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/strptime.cpython-310-x86_64-linux-gnu.so')"
