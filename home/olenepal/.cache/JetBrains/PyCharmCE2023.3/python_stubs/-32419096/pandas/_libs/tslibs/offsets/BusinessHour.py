...
class BusinessHour(BusinessMixin):
    ...
    next_bday = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7fd30157a700>'
    _adjust_dst = False
    _anchor = 0
    _attributes = (
        'n',
    ...
    _prefix = 'BH'
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fd2ef2a9a40>'
