...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x7fd2ef31c310>, \'dst\': <function tzutc.dst at 0x7fd2ef31c3a0>, \'tzname\': <function tzutc.tzname at 0x7fd2ef31c430>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x7fd2ef31c4c0>, \'fromutc\': <function tzutc.fromutc at 0x7fd2ef31c5e0>, \'__eq__\': <function tzutc.__eq__ at 0x7fd2ef31c670>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x7fd2ef31c700>, \'__repr__\': <function tzutc.__repr__ at 0x7fd2ef31c790>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _pytz_BaseTzInfo(__datetime.tzinfo):
    ...
    _tzname = None
    _utcoffset = None
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pytz.tzinfo', '_utcoffset': None, '_tzname': None, 'zone': None, '__str__': <function BaseTzInfo.__str__ at 0x7fd2ef722710>, '__dict__': <attribute '__dict__' of 'BaseTzInfo' objects>, '__weakref__': <attribute '__weakref__' of 'BaseTzInfo' objects>, '__doc__': None})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef2ecb80>'

__pyx_capi__ = {
    'get_dst_info': None, # (!) real value is '<capsule object "PyObject *(PyDateTime_TZInfo *)" at 0x7fd2ef2ed200>'
    'get_timezone': None, # (!) real value is '<capsule object "PyObject *(PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x7fd2ef2ed140>'
    'get_utcoffset': None, # (!) real value is '<capsule object "PyDateTime_Delta *(PyDateTime_TZInfo *, PyDateTime_DateTime *)" at 0x7fd2ef2ed1a0>'
    'is_fixed_offset': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x7fd2ef2ed1d0>'
    'is_tzlocal': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *)" at 0x7fd2ef2ed080>'
    'is_utc': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x7fd2ef2ed050>'
    'is_zoneinfo': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *)" at 0x7fd2ef2ed0b0>'
    'maybe_get_tz': None, # (!) real value is '<capsule object "PyDateTime_TZInfo *(PyObject *, int __pyx_skip_dispatch)" at 0x7fd2ef2ed170>'
    'treat_tz_as_pytz': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *)" at 0x7fd2ef2ed0e0>'
    'tz_compare': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *, PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x7fd2ef2ed110>'
    'utc_stdlib': None, # (!) real value is '<capsule object "PyDateTime_TZInfo *" at 0x7fd2ef2ed020>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timezones', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef2ecb80>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/timezones.cpython-310-x86_64-linux-gnu.so')"
