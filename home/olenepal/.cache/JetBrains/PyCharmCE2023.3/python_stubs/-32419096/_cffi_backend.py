...
# from /usr/lib/python3/dist-packages/_cffi_backend.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
class CField(object):
    ...
    bitshift = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    bitsize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class CLibrary(object):
    # no doc
    def close_lib(self, *args, **kwargs): # real signature unknown
        pass

    def load_function(self, *args, **kwargs): # real signature unknown
        pass

    def read_variable(self, *args, **kwargs): # real signature unknown
        pass

    def write_variable(self, *args, **kwargs): # real signature unknown
        pass
...
class CType(object):
    ...
    abi = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """function ABI"""
    ...
    ellipsis = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """function has '...'"""
    ...
    relements = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class FFI(object):
    ...
    buffer = buffer
    CData = None # (!) forward: _CDataBase, real value is "<class '_cffi_backend._CDataBase'>"
    CType = CType
...
class __CDataFromBuf(_CDataBase):
    """ This is an internal subtype of _CDataBase for performance only on CPython.  Check with isinstance(x, ffi.CData). """
    def __init__(self, *args, **kwargs): # real signature unknown
        pass
...
_C_API = None # (!) real value is '<capsule object "cffi" at 0x7fd3047ce1f0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047ce3b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_cffi_backend', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047ce3b0>, origin='/usr/lib/python3/dist-packages/_cffi_backend.cpython-310-x86_64-linux-gnu.so')"
