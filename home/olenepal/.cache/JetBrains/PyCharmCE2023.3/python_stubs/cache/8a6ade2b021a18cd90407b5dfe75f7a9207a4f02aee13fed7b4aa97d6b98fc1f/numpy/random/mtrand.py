...
class RandomState(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fd2ef923ed0>'
...
class Sequence(__collections_abc.Reversible, __collections_abc.Collection):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7fd304f72740>'
...
_rand = None # (!) real value is 'RandomState(MT19937) at 0x7FD2EF944740'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef9238e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random.mtrand', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef9238e0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/numpy/random/mtrand.cpython-310-x86_64-linux-gnu.so')"
