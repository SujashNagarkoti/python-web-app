...
class FeatureLibLocation(tuple):
    ...
    __orig_bases__ = (
        None, # (!) real value is '<function NamedTuple at 0x7fd304512950>'
    )
    __slots__ = ()
...
class IncludingLexer(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'fontTools.feaLib.lexer\', \'__doc__\': "A Lexer that follows include statements.\\n\\n    The OpenType feature file specification states that due to\\n    historical reasons, relative imports should be resolved in this\\n    order:\\n\\n    1. If the source font is UFO format, then relative to the UFO\'s\\n       font directory\\n    2. relative to the top-level include file\\n    3. relative to the parent include file\\n\\n    We only support 1 (via includeDir) and 2.\\n    ", \'__init__\': <cyfunction IncludingLexer.__init__ at 0x7fd30460dbe0>, \'__iter__\': <cyfunction IncludingLexer.__iter__ at 0x7fd30460dcb0>, \'next\': <cyfunction IncludingLexer.next at 0x7fd30460dd80>, \'__next__\': <cyfunction IncludingLexer.__next__ at 0x7fd30460de50>, \'make_lexer_\': <staticmethod(<cyfunction IncludingLexer.make_lexer_ at 0x7fd30460df20>)>, \'scan_anonymous_block\': <cyfunction IncludingLexer.scan_anonymous_block at 0x7fd30460dff0>, \'__dict__\': <attribute \'__dict__\' of \'IncludingLexer\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'IncludingLexer\' objects>})'
...
class Lexer(object):
    ...
    STRING = 'STRING'
    SYMBOL = 'SYMBOL'
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'fontTools.feaLib.lexer\', \'NUMBER\': \'NUMBER\', \'HEXADECIMAL\': \'HEXADECIMAL\', \'OCTAL\': \'OCTAL\', \'NUMBERS\': (\'NUMBER\', \'HEXADECIMAL\', \'OCTAL\'), \'FLOAT\': \'FLOAT\', \'STRING\': \'STRING\', \'NAME\': \'NAME\', \'FILENAME\': \'FILENAME\', \'GLYPHCLASS\': \'GLYPHCLASS\', \'CID\': \'CID\', \'SYMBOL\': \'SYMBOL\', \'COMMENT\': \'COMMENT\', \'NEWLINE\': \'NEWLINE\', \'ANONYMOUS_BLOCK\': \'ANONYMOUS_BLOCK\', \'CHAR_WHITESPACE_\': \' \\t\', \'CHAR_NEWLINE_\': \'\\r\\n\', \'CHAR_SYMBOL_\': ",;:-+\'{}[]<>()=", \'CHAR_DIGIT_\': \'0123456789\', \'CHAR_HEXDIGIT_\': \'0123456789ABCDEFabcdef\', \'CHAR_LETTER_\': \'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz\', \'CHAR_NAME_START_\': \'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_+*:.^~!\\\\\', \'CHAR_NAME_CONTINUATION_\': \'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_.+*:^~!/-\', \'RE_GLYPHCLASS\': re.compile(\'^[A-Za-z_0-9.\\\\-]+$\'), \'MODE_NORMAL_\': \'NORMAL\', \'MODE_FILENAME_\': \'FILENAME\', \'__init__\': <cyfunction Lexer.__init__ at 0x7fd30460cc70>, \'__iter__\': <cyfunction Lexer.__iter__ at 0x7fd30460cfb0>, \'next\': <cyfunction Lexer.next at 0x7fd30460d630>, \'__next__\': <cyfunction Lexer.__next__ at 0x7fd30460d700>, \'location_\': <cyfunction Lexer.location_ at 0x7fd30460d7d0>, \'next_\': <cyfunction Lexer.next_ at 0x7fd30460d8a0>, \'scan_over_\': <cyfunction Lexer.scan_over_ at 0x7fd30460d970>, \'scan_until_\': <cyfunction Lexer.scan_until_ at 0x7fd30460da40>, \'scan_anonymous_block\': <cyfunction Lexer.scan_anonymous_block at 0x7fd30460db10>, \'__dict__\': <attribute \'__dict__\' of \'Lexer\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Lexer\' objects>, \'__doc__\': None})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047cd990>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.feaLib.lexer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047cd990>, origin='/home/olenepal/.local/lib/python3.10/site-packages/fontTools/feaLib/lexer.cpython-310-x86_64-linux-gnu.so')"
