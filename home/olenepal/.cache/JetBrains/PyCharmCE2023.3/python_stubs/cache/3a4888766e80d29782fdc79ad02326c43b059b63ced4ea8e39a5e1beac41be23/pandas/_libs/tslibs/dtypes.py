...
class Enum(object):
    ...
    name = None # (!) real value is '<types.DynamicClassAttribute object at 0x7fd304fa92d0>'
    value = None # (!) real value is '<types.DynamicClassAttribute object at 0x7fd304fa92a0>'
    _member_map_ = {}
    _member_names_ = []
    _member_type_ = object
    _value2member_map_ = {}
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'enum', '__doc__': '\\n    Generic enumeration.\\n\\n    Derive from this class to define new enumerations.\\n    ', '__new__': <staticmethod(<function Enum.__new__ at 0x7fd304fe9240>)>, '_generate_next_value_': <function Enum._generate_next_value_ at 0x7fd304fe92d0>, '_missing_': <classmethod(<function Enum._missing_ at 0x7fd304fe9360>)>, '__repr__': <function Enum.__repr__ at 0x7fd304fe93f0>, '__str__': <function Enum.__str__ at 0x7fd304fe9480>, '__dir__': <function Enum.__dir__ at 0x7fd304fe9510>, '__format__': <function Enum.__format__ at 0x7fd304fe95a0>, '__hash__': <function Enum.__hash__ at 0x7fd304fe9630>, '__reduce_ex__': <function Enum.__reduce_ex__ at 0x7fd304fe96c0>, 'name': <types.DynamicClassAttribute object at 0x7fd304fa92d0>, 'value': <types.DynamicClassAttribute object at 0x7fd304fa92a0>, '__dict__': <attribute '__dict__' of 'Enum' objects>, '__weakref__': <attribute '__weakref__' of 'Enum' objects>, '_member_names_': [], '_member_map_': {}, '_member_type_': <class 'object'>, '_value2member_map_': {}})"
...
class PeriodDtypeBase(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fd2ef7faee0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef7facb0>'

__pyx_capi__ = {
    'abbrev_to_npy_unit': None, # (!) real value is '<capsule object "NPY_DATETIMEUNIT (PyObject *, int __pyx_skip_dispatch)" at 0x7fd2ef7fad90>'
    'attrname_to_abbrevs': None, # (!) real value is '<capsule object "PyObject *" at 0x7fd2ef7facd0>'
    'attrname_to_npy_unit': None, # (!) real value is '<capsule object "PyObject *" at 0x7fd2ef7fad30>'
    'freq_group_code_to_npy_unit': None, # (!) real value is '<capsule object "NPY_DATETIMEUNIT (int)" at 0x7fd2ef7fadc0>'
    'get_supported_reso': None, # (!) real value is '<capsule object "NPY_DATETIMEUNIT (NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7fd2ef7fae50>'
    'is_supported_unit': None, # (!) real value is '<capsule object "int (NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7fd2ef7fae80>'
    'npy_unit_to_abbrev': None, # (!) real value is '<capsule object "PyObject *(NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7fd2ef7fad60>'
    'npy_unit_to_attrname': None, # (!) real value is '<capsule object "PyObject *" at 0x7fd2ef7fad00>'
    'periods_per_day': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_6dtypes_periods_per_day *__pyx_optional_args)" at 0x7fd2ef7fadf0>'
    'periods_per_second': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (NPY_DATETIMEUNIT, int __pyx_skip_dispatch)" at 0x7fd2ef7fae20>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.dtypes', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef7facb0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/dtypes.cpython-310-x86_64-linux-gnu.so')"
