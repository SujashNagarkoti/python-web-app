# encoding: utf-8
# module reportlab.graphics._renderPM
# from /usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
Interface summary:
    ...
    _renderPM.pil2pict(cols,rows,datastr,palette) return PICT version of
        im as bytes
    _renderPM.ft_get_face(fontName) --> ft_face instance

    _renderPM._libart_version base library version string
    _renderPM._version module version string ie 4.01
"""
# no imports

# Variables with simple values

_libart_version = '2.3.21'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047cdf00>'

__spec__ = None # (!) real value is "ModuleSpec(name='reportlab.graphics._renderPM', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3047cdf00>, origin='/usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-310-x86_64-linux-gnu.so')"
