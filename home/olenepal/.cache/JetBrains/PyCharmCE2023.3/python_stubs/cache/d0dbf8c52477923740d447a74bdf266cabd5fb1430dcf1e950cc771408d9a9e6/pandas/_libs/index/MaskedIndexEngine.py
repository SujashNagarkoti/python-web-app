...
class MaskedIndexEngine(IndexEngine):
    ...
    def _get_data(self, *args, **kwargs): # real signature unknown
        pass

    def _get_mask(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fd2ee2c8540>'
