...
# from /home/olenepal/.local/lib/python3.10/site-packages/fontTools/varLib/iup.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class Real(__numbers.Complex):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7fd304f427c0>'
    __abstractmethods__ = frozenset({'__eq__', '__floor__', '__mod__', '__mul__', '__float__', '__add__', '__rpow__', '__abs__', '__rmul__', '__rfloordiv__', '__pos__', '__truediv__', '__rtruediv__', '__le__', '__trunc__', '__pow__', '__ceil__', '__lt__', '__rmod__', '__floordiv__', '__radd__', '__round__', '__neg__'})
    __slots__ = ()
...
class Integral(__numbers.Rational):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7fd304f72840>'
    __abstractmethods__ = frozenset({'__eq__', '__rxor__', '__ror__', '__rshift__', '__floor__', '__mod__', '__mul__', '__or__', '__add__', '__rpow__', '__xor__', '__int__', '__and__', '__abs__', '__rmul__', '__rand__', '__rrshift__', '__rfloordiv__', '__pos__', '__lshift__', '__truediv__', '__rtruediv__', '__le__', '__trunc__', '__invert__', '__pow__', '__rlshift__', '__ceil__', '__lt__', '__rmod__', '__floordiv__', '__radd__', '__round__', '__neg__'})
    __slots__ = ()


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3042457e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.varLib.iup', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3042457e0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/fontTools/varLib/iup.cpython-310-x86_64-linux-gnu.so')"
