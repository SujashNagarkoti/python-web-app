...
VALID_CLOSED = None # (!) real value is "frozenset({'left', 'right', 'neither', 'both'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef7b6d70>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.interval', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef7b6d70>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/interval.cpython-310-x86_64-linux-gnu.so')"
