...
class ArrowExtensionArray(__pandas_core_arraylike.OpsMixin, __pandas_core_arrays_base.ExtensionArraySupportsAnyAll, __pandas_core_arrays__arrow_string_mixins.ArrowStringArrayMixin, __pandas_core_strings_base.BaseStringArrayMethods):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7fd2ee71eb00>'
...
class BooleanArray(__pandas_core_arrays_masked.BaseMaskedArray):
    ...
    _TRUE_VALUES = None # (!) real value is "{'True', 'TRUE', '1', 'true', '1.0'}"
    _truthy_value = True
...
class ExtensionDtype(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas.core.dtypes.base\', \'__annotations__\': {\'_metadata\': \'tuple[str, ...]\'}, \'__doc__\': "\\n    A custom data type, to be paired with an ExtensionArray.\\n\\n    See Also\\n    --------\\n    extensions.register_extension_dtype: Register an ExtensionType\\n        with pandas as class decorator.\\n    extensions.ExtensionArray: Abstract base class for custom 1-D array types.\\n\\n    Notes\\n    -----\\n    The interface includes the following abstract methods that must\\n    be implemented by subclasses:\\n\\n    * type\\n    * name\\n    * construct_array_type\\n\\n    The following attributes and methods influence the behavior of the dtype in\\n    pandas operations\\n\\n    * _is_numeric\\n    * _is_boolean\\n    * _get_common_dtype\\n\\n    The `na_value` class attribute can be used to set the default NA value\\n    for this type. :attr:`numpy.nan` is used by default.\\n\\n    ExtensionDtypes are required to be hashable. The base class provides\\n    a default implementation, which relies on the ``_metadata`` class\\n    attribute. ``_metadata`` should be a tuple containing the strings\\n    that define your data type. For example, with ``PeriodDtype`` that\'s\\n    the ``freq`` attribute.\\n\\n    **If you have a parametrized dtype you should set the ``_metadata``\\n    class property**.\\n\\n    Ideally, the attributes in ``_metadata`` will match the\\n    parameters to your ``ExtensionDtype.__init__`` (if any). If any of\\n    the attributes in ``_metadata`` don\'t implement the standard\\n    ``__eq__`` or ``__hash__``, the default implementations here will not\\n    work.\\n\\n    Examples\\n    --------\\n\\n    For interaction with Apache Arrow (pyarrow), a ``__from_arrow__`` method\\n    can be implemented: this method receives a pyarrow Array or ChunkedArray\\n    as only argument and is expected to return the appropriate pandas\\n    ExtensionArray for this dtype and the passed values:\\n\\n    >>> import pyarrow\\n    >>> from pandas.api.extensions import ExtensionArray\\n    >>> class ExtensionDtype:\\n    ...     def __from_arrow__(\\n    ...         self,\\n    ...         array: pyarrow.Array | pyarrow.ChunkedArray\\n    ...     ) -> ExtensionArray:\\n    ...         ...\\n\\n    This class does not inherit from \'abc.ABCMeta\' for performance reasons.\\n    Methods and properties required by the interface raise\\n    ``pandas.errors.AbstractMethodError`` and no ``register`` method is\\n    provided for registering virtual subclasses.\\n    ", \'_metadata\': (), \'__str__\': <function ExtensionDtype.__str__ at 0x7fd2eed7b130>, \'__eq__\': <function ExtensionDtype.__eq__ at 0x7fd2eed7b1c0>, \'__hash__\': <function ExtensionDtype.__hash__ at 0x7fd2eed7b250>, \'__ne__\': <function ExtensionDtype.__ne__ at 0x7fd2eed7b2e0>, \'na_value\': <property object at 0x7fd2eeda3dd0>, \'type\': <property object at 0x7fd2eeda3e20>, \'kind\': <property object at 0x7fd2eeda3ec0>, \'name\': <property object at 0x7fd2eedb4770>, \'names\': <property object at 0x7fd2eedb4090>, \'construct_array_type\': <classmethod(<function ExtensionDtype.construct_array_type at 0x7fd2eed7b640>)>, \'empty\': <function ExtensionDtype.empty at 0x7fd2eed7b6d0>, \'construct_from_string\': <classmethod(<function ExtensionDtype.construct_from_string at 0x7fd2eed7b760>)>, \'is_dtype\': <classmethod(<function ExtensionDtype.is_dtype at 0x7fd2eed7b7f0>)>, \'_is_numeric\': <property object at 0x7fd2eedb4130>, \'_is_boolean\': <property object at 0x7fd2eedb4180>, \'_get_common_dtype\': <function ExtensionDtype._get_common_dtype at 0x7fd2eed7b9a0>, \'_can_hold_na\': <property object at 0x7fd2eedb4220>, \'_is_immutable\': <property object at 0x7fd2eedb42c0>, \'__dict__\': <attribute \'__dict__\' of \'ExtensionDtype\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'ExtensionDtype\' objects>})'
...
class CategoricalDtype(__pandas_core_dtypes_dtypes.PandasExtensionDtype, __pandas_core_dtypes_base.ExtensionDtype):
    ...
    _cache_dtypes = {}
    _hash_categories = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7fd2eedc0580>'
    _metadata = (
        'categories',
        'ordered',
    )
...
class TextReader(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fd2ed645350>'
...
STR_NA_VALUES = None # (!) real value is "{'', '#NA', '-nan', 'nan', 'NaN', '<NA>', 'None', 'NA', '#N/A', 'NULL', 'n/a', '-1.#QNAN', 'N/A', '1.#IND', 'null', '1.#QNAN', '-1.#IND', '#N/A N/A', '-NaN'}"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ed644af0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.parsers', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ed644af0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/parsers.cpython-310-x86_64-linux-gnu.so')"
