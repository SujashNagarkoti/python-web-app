...
class BaseOffset(object):
    ...
    freqstr = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7fd2ef2a6f40>'
    _adjust_dst = True
    _attributes = (
        'n',
        'normalize',
    ...
    _day_opt = None
    _params = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x7fd2ef7efc40>'
