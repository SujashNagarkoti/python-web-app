...
# from /home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/fields.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
class LocaleTime(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_strptime', '__doc__': 'Stores and handles locale-specific information related to time.\\n\\n    ATTRIBUTES:\\n        f_weekday -- full weekday names (7-item list)\\n        a_weekday -- abbreviated weekday names (7-item list)\\n        f_month -- full month names (13-item list; dummy value in [0], which\\n                    is added by code)\\n        a_month -- abbreviated month names (13-item list, dummy value in\\n                    [0], which is added by code)\\n        am_pm -- AM/PM representation (2-item list)\\n        LC_date_time -- format string for date/time representation (string)\\n        LC_date -- format string for date representation (string)\\n        LC_time -- format string for time representation (string)\\n        timezone -- daylight- and non-daylight-savings timezone representation\\n                    (2-item list of sets)\\n        lang -- Language used by instance (2-item tuple)\\n    ', '__init__': <function LocaleTime.__init__ at 0x7fd2ef379c60>, '_LocaleTime__calc_weekday': <function LocaleTime.__calc_weekday at 0x7fd2ef379cf0>, '_LocaleTime__calc_month': <function LocaleTime.__calc_month at 0x7fd2ef379d80>, '_LocaleTime__calc_am_pm': <function LocaleTime.__calc_am_pm at 0x7fd2ef379e10>, '_LocaleTime__calc_date_time': <function LocaleTime.__calc_date_time at 0x7fd2ef379ea0>, '_LocaleTime__calc_timezone': <function LocaleTime.__calc_timezone at 0x7fd2ef379f30>, '__dict__': <attribute '__dict__' of 'LocaleTime' objects>, '__weakref__': <attribute '__weakref__' of 'LocaleTime' objects>})"
...
class RoundTo(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.fields\', \'__doc__\': \'\\n    enumeration defining the available rounding modes\\n\\n    Attributes\\n    ----------\\n    MINUS_INFTY\\n        round towards -?, or floor [2]_\\n    PLUS_INFTY\\n        round towards +?, or ceil [3]_\\n    NEAREST_HALF_EVEN\\n        round to nearest, tie-break half to even [6]_\\n    NEAREST_HALF_MINUS_INFTY\\n        round to nearest, tie-break half to -? [5]_\\n    NEAREST_HALF_PLUS_INFTY\\n        round to nearest, tie-break half to +? [4]_\\n\\n\\n    References\\n    ----------\\n    .. [1] "Rounding - Wikipedia"\\n           https://en.wikipedia.org/wiki/Rounding\\n    .. [2] "Rounding down"\\n           https://en.wikipedia.org/wiki/Rounding#Rounding_down\\n    .. [3] "Rounding up"\\n           https://en.wikipedia.org/wiki/Rounding#Rounding_up\\n    .. [4] "Round half up"\\n           https://en.wikipedia.org/wiki/Rounding#Round_half_up\\n    .. [5] "Round half down"\\n           https://en.wikipedia.org/wiki/Rounding#Round_half_down\\n    .. [6] "Round half to even"\\n           https://en.wikipedia.org/wiki/Rounding#Round_half_to_even\\n    \', \'MINUS_INFTY\': <property object at 0x7fd2ef3a6430>, \'PLUS_INFTY\': <property object at 0x7fd2ef3a6480>, \'NEAREST_HALF_EVEN\': <property object at 0x7fd2ef3a64d0>, \'NEAREST_HALF_PLUS_INFTY\': <property object at 0x7fd2ef3a6520>, \'NEAREST_HALF_MINUS_INFTY\': <property object at 0x7fd2ef3a6570>, \'__dict__\': <attribute \'__dict__\' of \'RoundTo\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'RoundTo\' objects>})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef3733d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.fields', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd2ef3733d0>, origin='/home/olenepal/.local/lib/python3.10/site-packages/pandas/_libs/tslibs/fields.cpython-310-x86_64-linux-gnu.so')"
